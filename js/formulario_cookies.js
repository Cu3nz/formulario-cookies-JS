...
function setCookie(cname, cvalue) {
  ...
  if (problemaValidacion){
    ...
    console.log('%c ***** Error no se han podido almacenar las cookies, verifica tus datos con los errores mostrados por consola e intenta de nuevo  ', 'color: red; font-size: 16px;');
